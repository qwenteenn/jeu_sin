...
const std::unordered_map<std::string, ItemDef>& ItemDB() {
    static std::unordered_map<std::string, ItemDef> db = {
        ...
        {"defense_talisman", {"defense_talisman", "Talisman defensif", "relic", 250, 75, false, true}},
        {"ancient_key", {"ancient_key", "Cle ancienne", "key", 120, 40, false, false}},

        {"weapon_mage_staff", {"weapon_mage_staff", "Baton elementaire", "weapon", 150, 45, false, false, 8, 0.05f, 2.0f, "mage"}},
        {"weapon_necro_grimoire", {"weapon_necro_grimoire", "Grimoire sombre", "weapon", 180, 55, false, false, 7, 0.04f, 2.0f, "necromancer"}},
        {"weapon_short_sword", {"weapon_short_sword", "Epee courte", "weapon", 150, 45, false, false, 10, 0.10f, 0.3f, "fighter"}},
        ...
        {"weapon_monk_staff", {"weapon_monk_staff", "Baton de moine", "weapon", 190, 60, false, false, 10, 0.08f, 0.9f, "monk"}},
        {"armor_light", {"armor_light", "Armure legere", "armor", 200, 55, false, false}},

        {"scarab_shell", {"scarab_shell", "Carapace de scarabee", "loot", 0, 7, true, false}},
        {"weak_venom", {"weak_venom", "Venin faible", "loot", 0, 9, true, false}},
        {"ancient_bone", {"ancient_bone", "Os ancien", "loot", 0, 10, true, false}},
        {"rusted_weapon_fragment", {"rusted_weapon_fragment", "Fragment d'arme rouillee", "loot", 0, 12, true, false}},
        {"cursed_bandage", {"cursed_bandage", "Bandelette maudite", "loot", 0, 16, true, false}},
        {"ancient_dust", {"ancient_dust", "Poussiere ancienne", "loot", 0, 14, true, false}},
        {"spectral_essence", {"spectral_essence", "Essence spectrale", "material", 0, 22, false, true}},
        {"soul_fragment", {"soul_fragment", "Fragment d'ame", "material", 0, 24, false, true}},
        ...
        {"broken_relic", {"broken_relic", "Relique cassee", "loot", 0, 35, false, true}},
        ...
        {"soul_crystal", {"soul_crystal", "Cristal d'ame", "material", 0, 130, false, true}},
