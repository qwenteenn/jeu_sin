...
CraftingStation::CraftingStation() {
    recipes_ = {
        ...
        {"soul_crystal", "4 essences spectrales -> cristal d'âme", {{"spectral_essence", 4}}, "soul_crystal", 1, 50},
        {"ancient_relic", "10 reliques cassées -> relique ancienne", {{"broken_relic", 10}}, "ancient_relic", 1, 100},
        {"return_crystal", "1 relique + 2 cristaux d'âme -> cristal retour stable", {{"ancient_relic", 1}, {"soul_crystal", 2}}, "stable_return_crystal", 1, 200},
