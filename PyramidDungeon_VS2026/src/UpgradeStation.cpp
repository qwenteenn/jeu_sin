...
UpgradeStation::UpgradeStation() {
    upgrades_ = {
        {"vitality", "Vitalite", "+10 vie max par niveau", 90, "ancient_bone", 1, 20},
        {"strength", "Force", "+5% degats physiques", 120, "golem_fragment", 1, 15},
        {"magic", "Puissance magique", "+5% degats magiques", 120, "weak_crystal", 2, 15},
        {"defense", "Defense", "-3% degats recus", 130, "stone_core", 1, 12},
        {"speed", "Vitesse", "+2% vitesse", 100, "scarab_shell", 4, 10},
        {"mana", "Maitrise du mana", "+10 mana max", 100, "spectral_essence", 1, 15},
        {"ki", "Maitrise du ki", "+10 ki max", 100, "cursed_bone_powder", 1, 15},
        {"necromancy", "Necromancie", "Invocations plus resistantes", 130, "soul_fragment", 2, 12},
        {"loot", "Instinct du pilleur", "+2% chance de drop rare", 180, "ancient_relic", 1, 10},
        {"trap_resist", "Peau de pierre", "+5% resistance aux pieges", 150, "golem_fragment", 2, 10}
    };
}
