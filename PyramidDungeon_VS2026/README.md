...
- Visual Studio Community 2026 Insider ou Build Tools 2026.
- Composant C++ installé : MSVC x64.
- Windows SDK installé.
- CMake accessible dans le PATH.
- Git accessible dans le PATH, car raylib est téléchargé automatiquement au premier build.
